...
class repo_multiline(npyscreen.MultiLine):
    def display_value(self,vl):
        return "{:15} {:30} {:10} {:15} {:9}".format(vl[0],vl[1],vl[2],vl[3],vl[4])
...
class MainForm(npyscreen.ActionForm):
    def create(self,*args,**keywords):
        ...
        self.add_widget(npyscreen.FixedText,editable=False,color='green',value="{:15} {:30} {:10} {:15} {:7}".format('Repo Name','Repo Path','Branch','Tracking','u/t/r/a'))
